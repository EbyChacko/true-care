...
from .models import CustomerMessage, DoctorDiagnosis, Prescription
from .models import ReportNames, MedicalReport
...
class DoctorAdmin(admin.ModelAdmin):
    list_display = ('get_personal_details_name', 'designation',
                    'education', 'speciality', 'department')
    search_fields = ('personal_details__name', 'personal_details__email',
...
class PatientAdmin(admin.ModelAdmin):
    list_display = ('get_personal_details_name', 'date_of_birth',
                    'get_personal_details_email', 'get_mobile')
    search_fields = ('personal_details__name', 'personal_details__email',
                     'patient_age')
...
class BookingAdmin(admin.ModelAdmin):
    list_display = ('patient_id', 'department', 'doctor', 'booking_date',
                    'date_booked', 'approved')
    search_fields = ('patient_id__personal_details__name',
                     'department__department_name',
                     'doctor__personal_details__name')
...
class prescriptionAdmin(admin.ModelAdmin):
    list_display = ('booking', 'drug_name', 'dose', 'frequency',
                    'route', 'quantity')
